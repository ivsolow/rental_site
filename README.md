...
### Backend for a tourist equipment rental website using Django Rest Framework.
...
def generate_secret_key(length=50):
    ...
    secret_key = prefix + generated_string
    return secret_key
...
Primary endpoint documentation is created using Swagger UI and the drf-spectacular library. It is accessible at: /docs/

Here's a brief description of functionality:
...
Основная документация по эндпойнтам создана на основе Swagger UI, с помощью библиотеки `drf-spectacular` и доступна по адресу: `/docs/`

Вот краткое описание функциональности:
